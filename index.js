...
ryNqwHMHp/gYIFG1kZj3ocY3vf6iLgppFdwMh7354f83faZJW5Z5W8vzPRZuf2+jqWtr1mFQPbTNN2Mnwg8IeSksaSwIZntZJMDuC

+wI3rzrGP026nY+EURjb5vt3r6ulYg9eF3fCwfZGwZQHrKW3wdB04t89/1O/w1cDnyilFU='
...
//上面的部分呢，是LINE BOT能夠運轉，和伺服器的一些連結與認證有關。坦白說有很多部份我也不太確定是幹嘛用的，不要亂動
...
['https://i.imgur.com/mt7NVzr.png','https://i.imgur.com/v094wOd.png','https://i.imgur.com/F5RfDW2.png','https://i.i

mgur.com/jWm6f6z.png']
  },
  {
    chack: ['我覺得不行'],
...
['https://i.imgur.com/7BTPpPQ.png','https://i.imgur.com/nweWacp.png','https://i.imgur.com/j0hIscH.png','https://i.i

mgur.com/9BDCkJr.png','https://i.imgur.com/2ZiVw9g.png']
  }
...
function Dice(diceSided){
  ...
  //接下來就要說 Math.floor() 了，它會把數字的小數部分無條件捨棄掉，變成整數。所以把上面那個餵他之後就會出現0~5這六
...
function nomalDiceRoller(inputStr){
  ...
  if (DiceToRoll.match('d') == null) return undefined;
    ...
    //報錯，不解釋。
    if(finalStr.match('200D')!= null) finalStr = '欸欸，不支援200D以上擲骰；哪個時候會骰到兩百次以上？想被淨灘
...
function DiceCal(inputStr){
  ...
  while(DiceToRoll.match(/\d+d\d+/)!=null) {
    ...
    if (tempMatch.toString().split('d')[0]>200) return '欸欸，不支援200D以上擲骰；哪個時候會骰到兩百次以上？想被淨

灘嗎？';
    if (tempMatch.toString().split('d')[1]==1 || tempMatch.toString().split('d')[1]>500) return '不支援D1和超過D500
...
最終值為：'+ chack + '+' + plus +'='+ (chack + plus);
  ...
  if(Math.abs(BPDice) != 1 && Math.abs(BPDice) != 2 && BPDice != null) return 'CoC7th的獎懲骰，允許的範圍是一到兩顆
...
去' + AdjustValue.AppDebuff +'點。可做' + AdjustValue.EDUinc + '次EDU的成長擲骰。' ;
    }
    else {
...
function ccbg(){
  ...
  let bg = {
    //基本描述
    //PersonalDescription
    PD :['結實的', '英俊的', '粗鄙的', '機靈的', '迷人的', '娃娃臉的', '聰明的', '蓬頭垢面的', '愚鈍的', '骯髒的', 

'耀眼的', '有書卷氣的','青春洋溢的','感覺疲憊的','豐滿的','粗壯的','毛髮茂盛的','苗條的','優雅的','邋遢的','敦實

的','蒼白的','陰沉的','平庸的','臉色紅潤的','皮膚黝黑色','滿臉皺紋的','古板的','有狐臭的','狡猾的','健壯的','嬌俏的

','筋肉發達的','魁梧的','遲鈍的', '虛弱的'],
    
    //信念
    //IdeologyBeliefs
    IB :['虔誠信仰著某個神祈','覺得人類不需要依靠宗教也可以好好生活','覺得科學可以解釋所有事，並對某種科學領域有獨

特的興趣','相信因果循環與命運','是一個政黨、社群或秘密結社的成員','覺得這個社會已經病了，而其中某些病灶需要被剷

除','是神秘學的信徒','是積極參與政治的人，有特定的政治立場','覺得金錢至上，且為了金錢不擇手段','是一個激進主義分子

，活躍於社會運動'],
    
    //重要之人
    //SignificantPeople
    SP :['他的父母', '他的祖父母', '他的兄弟姐妹', '他的孩子', '他的另一半', '那位曾經教導調查員最擅長的技能（點數

最高的職業技能）的人','他的兒時好友', '他心目中的偶像或是英雄', '在遊戲中的另一位調查員', '一個由KP指定的NPC'],
    
    //這個人為什麼重要
    //SignificantPeopleWhy
    SPW :['調查員在某種程度上受了他的幫助，欠了人情','調查員從他那裡學到了些什麼重要的東西','他給了調查員生活的意義

','調查員曾經傷害過他，尋求他的原諒','和他曾有過無可磨滅的經驗與回憶','調查員想要對他證明自己','調查員崇拜著他','調

查員對他有著某些使調查員後悔的過往','調查員試圖證明自己和他不同，比他更出色','他讓調查員的人生變得亂七八糟，因此調

查員試圖復仇'],
    
    //意義非凡之地
    //MeaningfulLocations
    ML :['過去就讀的學校','他的故鄉','與他的初戀之人相遇之處','某個可以安靜沉思的地方','某個類似酒吧或是熟人的家那

樣的社交場所','與他的信念息息相關的地方','埋葬著某個對調查員別具意義的人的墓地','他從小長大的那個家','他生命中最快

樂時的所在','他的工作場所'],
    
    //寶貴之物
    //TreasuredPossessions
    TP :['一個與他最擅長的技能（點數最高的職業技能）相關的物品','一件他的在工作上需要用到的必需品','一個從他童年時

就保存至今的寶物','一樣由調查員最重要的人給予他的物品','一件調查員珍視的蒐藏品','一件調查員無意間發現，但不知道到底

是什麼的東西，調查員正努力尋找答案','某種體育用品','一把特別的武器','他的寵物'],
    
    //特徵
    //Traits
    T :['慷慨大方的人','對動物很友善的人','善於夢想的人','享樂主義者','甘冒風險的賭徒或冒險者', '善於料理的人', '萬

人迷','忠心耿耿的人','有好名聲的人','充滿野心的人']
    
  }


  return 'CoC7th背景描述生成器\n（僅供娛樂用，不具實際參考價值）\n==\n調查員是一個' + bg.PD[Dice(bg.PD.length)-1] + 

'人。\n【信念】：說到這個人，他' + bg.IB[Dice(bg.IB.length)-1] + '。\n【重要之人】：對他來說，最重要的人是' + 

bg.SP[Dice(bg.SP.length )-1] + '，這個人對他來說之所以重要，是因為' + bg.SPW[Dice(bg.SPW.length )-1] + '。\n【意義

非凡之地】：對他而言，最重要的地點是' + bg.ML[Dice(bg.ML.length )-1] + '。\n【寶貴之物】：他最寶貴的東西就是'+ 

bg.TP[Dice(bg.TP.length )-1] + '。\n【特徵】：總括來說，調查員是一個' + bg.T[Dice(bg.T.length)-1] + '。';
...
';
  ...
  if(inputStr.match('選') != null||inputStr.match('決定') != null||inputStr.match('挑') != null) {
    ...
    if(Answer.match('選') != null||Answer.match('決定') != null||Answer.match('挑') != null||Answer.match('鴨霸獸') 

!= null) {
      rplyArr = ['幹，你不會自己決定嗎', '人生是掌握在自己手裡的', '隨便哪個都好啦', '連這種東西都不能決定，是不是

不太應該啊', '沒事別叫我選東西好嗎，難道你們都是天秤座嗎（戰）', '不要把這種東西交給機器人決定比較好吧'];
 ...
 //以下是幫眾限定的垃圾話
    let message = [
      ...
      {
        chack: ['鴨霸幫'],
        text: ['要加入鴨霸幫是沒有這麼容易的，你必須經過重重考驗，攀登過末日火山，穿越過幽暗水道，戰勝九頭蜥蜴，並
...
且躍過無底深淵。\n\n\n或者你也可以選擇月付１９９９成為白銀幫眾。現在加入前三個月還打八折喔。']
      ...
      {
        chack: ['864','巴魯斯','sora'],
        text: ['呃啊啊啊啊啊啊啊啊──！！！不對、我幹嘛要做反應？', '阿，這是新的一天來臨的訊號。', 'バルス！', 

'burrs！', 'Barış！', 'Bals！', 'Barusu！' ]
      },
      {
        chack: ['康青龍'],
        text: ['淨灘之力與康青龍同在。']
...
太不可思議了！',
               '中壢，李性，閃亮（燦笑）', '混亂善娘（燦笑）', '黑熊熊穿浴衣👘～黑熊熊穿浴衣👘～耶嘿～', '黑熊醬這
...
樣可愛的女孩，沒男朋友真是太不可思議了']
  ...
  if(inputStr.match('運勢') != null){
    let rplyArr=['超大吉','大吉','大吉','中吉','中吉','中吉','小吉','小吉','小吉','小吉','凶','凶','凶','大凶','大

凶','你還是，不要知道比較好','這應該不關我的事'];
...
function Yababang(inputStr) {
  ...
  if (inputStr.match('yabaso') != null||inputStr.match('巴獸') != null||inputStr.match('鴨巴') != null||

inputStr.match('鴨嘴獸') != null||inputStr.match('幫主') != null||inputStr.match('泰瑞') != null) return '幫主好！

幹，那邊那個菜比巴，看到幫主不會敬禮啊，想被淨灘是不是？！';
  
  //if (inputStr.match('請問') != null||inputStr.match('柯基') != null||inputStr.match('默兒') != null||

inputStr.match('他口') != null||inputStr.match('桑尼') != null||inputStr.match('桑妮') != null||inputStr.match('阿

歐西') != null||inputStr.toLowerCase().match('roc') != null||inputStr.match('軒哥') != null) return '那個，關主不要
...
隔壁的櫃檯繳納會費，然後期待下一次淨灘的時候你還可以存活下來。';
...
機，在請問的面前課了一單明星三缺一，成為了請問的衣食父母，通過了關卡。','\
...
後回傳了回去，雖然甚麼事情都沒發現，但是你感覺你似乎度過了這場試煉。','\
在你面前突然出現了一座小島！！！\n該怎麼辦呢？\n\n\
...
什麼，你揚長而去。','\
一頭巨大的，頭上寫著「大家的小三」的倉鼠出現在'+pl+'的眼前，他說：「你怎麼會玩這個一點意義都沒有的無聊遊戲？聽話，

乖，回去吃你的飯備你的團寫你的程式背你的英文單字好好的過你的生活，放棄入幫測驗吧。」\n\n你不慌不忙的拿出line keep，

倉鼠就一邊哭一邊拖著行李箱離家出走了。','\
你踏進第三關的房間。突然，你周遭的空氣變得非常寒冷，燈光也變得幽暗下來。你感到一股由骨髓深處竄出的寒冷。正當你不知

所措的時候。從你背後傳來了一個可怕的聲音……\n\n\
「……你４不４……」話語到這裡就中斷了。\n\n\
話語到這裡就中斷了。你站立在原地，不知如何是好。\n但聲音也沒有進一步的舉動，看來是在等待你的回應。\n\n\
「你４不４想拔嘴人家！！！」你毫不猶豫的大聲回答。\n「你４在大聲甚麼啦！」後面的聲音也７ｐｕｐｕ的吼了回來！\n\n就

當你猛然轉頭回去的瞬間，周遭的空氣變回平常的溫度，而燈光也不知何時恢復了。\n你似乎突破了這個試煉。\
'];
  
  if(stage==4)rplyArr = ['\
「可惡！我也想上鴨霸幫挑戰！」一隻非常擅長密室逃脫的他口擋住了你的去路，「我也想要當關主啊！」\n\n'+pl+'正想說什麼

的時候，忽然有個人跳出來說，「那你就去投稿啊幹！」，他口就哭著跑走了。雖然你一頭霧水但還是平安的通過了這一關。','\
...
，遞給你一塊栗子泥蛋糕作為通關的證明，然後一個轉眼就消失了。\
'];
  
  if(stage==5)rplyArr = ['\
終於來到最後的考驗現場，只見一個男子站在房間的正中，他說：「你以為你現在正在參加鴨霸幫的入幫測驗嗎？不，這都是你的

錯覺，其實你只不過是我的副人格而已。」\n\n'+pl+'聽到這樣的話語，只遲疑了一下，說：「阿歐西，你有空在這邊練肖威，還

不快去把你的協作平台弄好，都拖多久了？」\n\n男子聽到之後，不由自主的雙腿一軟，但你還是繼續說道：「有空在這邊加鴨霸

獸的功能，不會去把復興南村的下一個劇本寫出來嗎？」\n\n男子咳出一口鮮血，倒臥在地。你就這樣跨過了他的身體，通過了最

後的試煉。', pl+'來到了最後考驗的現場，鴨霸幫的幫主——鴨巴獸坐在王座上，她的左手拿著包子、右手拿著鍋貼，眼神似乎要

你選擇的樣子。\n\n你微微一笑，指著座上的鴨巴獸說：「真正的鴨巴獸根本不會拿著這種東西，你一定是軒哥假扮的！」\n軒哥

冷笑了兩聲，扯下面具，「真虧你能看得出來，看來我該讓腎了。」他打開了最後的大門，你走出大門，通過了最後的試煉。\
'];
...
抓頭，請問覺得你抓頭的樣子很像猴子，於是用慘絕人寰的方式殺害了你。','\
你看到一個牌子寫著測驗入口，鴨霸幫的傳統測驗第一關就是攀登末日火山，穿越幽暗水道，戰勝九頭蜥蜴，並且躍過無底深淵。
...
之後，不知為何敵人的攻擊總是落到了你的身上，漸漸的你也失去了繼續前進的力量，倒在了不知名的路上。','\
你的手機突然亮起，Line上傳來了不知名的訊息。\n\n「巴獸真的很嚴格。」\n「比我想像的嚴格！」\n「幫我把這幾句Keep起來

。」\n\n奇怪的訊息出現了，到底要怎麼Keep才是正確的呢？\n\n你穩扎穩打的把三句話都完完整整的Keep下來。就在你信心滿滿
...
現了大量的高麗菜！」你興致更高的大喊。隨即小島上就出現了大量的高麗菜，柯基們都像發了瘋似的瘋狂啃食這些不速之菜。\n

\n你玩的不亦樂乎，沉醉在這個自己可以呼風喚雨的小島上。\n但你沒發現，這座小島在你不注意的時候，已經漂離凡世越來越遠

、越來越遠……你就這樣與這座小島消失在虛空之中。\
'];
  
  if(stage==3)rplyArr = ['\
「cc(2)<=1 古小蜜學」「(1D100<=1) → 46、96、16 → 16 → 失敗」'+pl+'看到一群人說著你不懂的語言。\n\n當你正準備逃跑

的時候他們忽然衝了上來，口吐褻瀆的語句：\n「cc(2)<=10 請問學」「cc(2)<=10 柯基學」「cc(2)<=10 ㄌㄌ學」將你淹沒
...
想要從他身邊繞過去，殊不知他忽然說「算了，反正就算我當不成關主，我還有很多妹子。要妹子，找他口。」\n你聽到這樣的話
...
正當你想開口再說些甚麼時，你的視線卻突然越來越後退。在你的視野中，你只看到那個女性，以及站在女性前面的那個。已失去
...
錯覺，其實你只不過是我的副人格而已。」\n\n'+pl+'聽到這樣的話語，陷入了長考——難、難道我，只是一個幻想出來的人格嗎

？我所認知的世界，都是虛幻嗎？！'+pl+'的身軀逐漸崩解，被吸入男子的影子當中。他微笑著說，「整個湯群，都是我的副人格

。」', pl+'來到了最後考驗的現場，鴨霸幫的幫主——鴨巴獸坐在王座上，她的左手拿著包子、右手拿著鍋貼，眼神似乎要你選擇

的樣子。\n\n你戰戰兢兢的，指著她右手的鍋貼，此時巴獸用迅雷不及掩耳盜鈴的速度用鍋貼把你的眼睛挖出來，再把包子塞到你
